...
import (
	...
	"github.com/submariner-io/submariner-operator/internal/table"
...
func Connections(newCluster *cluster.Info, status reporter.Interface, writer io.Writer) bool {
	...
	return getConnectionsStatus(newCluster, status, writer)
}

func getConnectionsStatus(newCluster *cluster.Info, status reporter.Interface, writer io.Writer) bool {
	...
	status.End()
	connectionPrinter.Print(connStatus, writer)
